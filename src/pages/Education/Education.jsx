...
const EducationSection = () => {
  ...
  const educationData = [
    ...
    },
    {
      ...
      school: "ASM B V M I College, Khata (Uttar Pradesh Board)",
      mascot: "📗",
      year: "2018–2019",
      achievements: ["Percentage: 76.2%", "Stream: Science"],
      skills: ["Physics", "Chemistry", "Mathematics", "English"],
      description:
        "Studied science stream with emphasis on theoretical concepts and problem-solving across key technical subjects.",
    },
    {
      ...
      mascot: "📘",
      year: "2017–2018",
      achievements: ["Percentage: 83.2%"],
      skills: ["Mathematics", "Science", "English", "Social Science"],
      description:
        "Built a strong foundation in communications (English) and logical reasoning skills.",
    },
  ];
